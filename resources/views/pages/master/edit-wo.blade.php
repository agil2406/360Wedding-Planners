                ...
                <div class="card-body">
                    ...
                    <form action="{{url('/wo'.'/'.$data->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control @error ('nama_ig') is-invalid @enderror" id="nama_ig" name="nama_ig" value="{{ $data->nama_ig}}">
                                @error('nama_ig')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error ('no_hp') is-invalid @enderror" id="no_hp" name="no_hp" value="{{ $data->no_hp}}" placeholder="875123654879">
                                    @error('no_hp')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
