        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 center">
                     <h4>Ayodiya paket <br> wedding organizer</h4>
                </div>
            </div>
            <div class="row">
            <div class="slider">
                        ...
                        <a href="/paket-akad" style="text-decoration: none; color:black;">
                            <div class="slider-card">
                                ...
                                <div class="container">
                                    ...
                                    <p class="small">byAyodiya Wedding Organinizer - Wedding Organizer</p>
                ...
                <div class="col-md-4 center">
                    <div class="card card-galery">
                        ...
                        <div class="card-body ">
                            ...
                            <h5>Sosial Media</h5>
                            <p class="mb-0">instagram : Ayodiya-wedding-org</p>
                            <p>Facebok : Ayodiya-wedding-org</p>
  ...
  <div class="container">
    <div class="row center">
      <div class="col-sm-12 text-center">
        <h4>Ayodiya Wedding Organizer <br> Location </h4>
      </div>
